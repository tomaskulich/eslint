...
module.exports = function(context) {
     ...
     */
    function isCommentAtBlockStart() {
        var ancestors = context.getAncestors();
        return ancestors.length > 0 && ancestors[ancestors.length - 1].type === "BlockStatement";
    }
    ...
    function checkForEmptyLine(node, opts) {
        ...
        // if block start is allowed and comment is at block start then return
        if (options.allowBlockStart && isCommentAtBlockStart()) {
            return;
        }
